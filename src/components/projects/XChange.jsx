          ...
          <section className='projectSection'>
            <div className='projectTextAndImageContainer'>
              <div className='projectsTextContainer'>
                <h3>xChange app</h3>
                <div>
                  <p>A web app that allows quick and easy conversion of the world's top currencies.</p>
                  <ul>
                    <li>TypeScript</li>
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body style={{backgroundColor: '#FAF9F6', color: '#202020'}}>
              <div className='modalTextContainer'>
                <p>
                xChange connects to the <a href='https://freecurrencyapi.com/docs' target='_blank'>Free currency API </a>
                 for daily exchange rates of the world's top currencies.
                Choose any of the available base and target currencies and get that day's conversion rate. 
                Use one of the inputs and the app will automatically create the equivilent amount of the other currency based on the conversion rate. 
                Interact with the tsparticles animation. 
                Open up a Bootstrap modal containing links to the API documentation and disclaimers. Fast and Responsive for any screen size.</p>
